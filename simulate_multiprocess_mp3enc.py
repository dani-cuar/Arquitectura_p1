...
def process1(i): 
    ...
    OUTDIR = "/gem5/m5out_multiprocess/mp3_enc_l1i_size="+combs[i][0]+"_l1d_size="+combs[i][1]+"_l2_size="+combs[i][2]+"_l3_size="+combs[i][3]+"_rob="+str(combs[i][4])+"_btb="+str(combs[i][5])+"_num_ALU="+str(combs[i][6])+"_issue_width="+str(combs[i][7])
    command = GEM5PATH+"/gem5.opt "+" --outdir="+OUTDIR+" "+SCRIPTPATH+"/CortexA76.py --cmd="+WORKLOADS+"/mp3_enc/mp3_enc --options=\""+WORKLOADS+"/mp3_enc/mp3enc_testfile.wav mp3enc_outfile.mp3\" "+MOREOPTIONS
    #command = GEM5PATH+"/gem5.opt "+" --outdir=/gem5/m5out_multiprocess/mp3_enc_l1i "+SCRIPTPATH+"/CortexA76.py --cmd="+WORKLOADS+"/mp3_enc/mp3_enc --options=\""+WORKLOADS+"/mp3_enc/mp3enc_testfile.wav mp3enc_outfile.mp3\""
